...
public class GameOverScreen implements Screen {
    ...
    public GameOverScreen(TheKingdomOfLegends game) {
        this.game = game;
        this.batch = new SpriteBatch();
        this.background = new Texture("game/backgroundGameOver.png");
        if (this.background == null) {
            Gdx.app.error("GameOverScreen", "Erreur de chargement de l'image");
        }

        this.menuOptions = new String[]{"Continue", "Exit"};
    ...
    public void render(float delta) {
        ...
        if (Gdx.input.isKeyJustPressed(Input.Keys.UP) && currentSelection > 0) {
            ...
            if (currentSelection == 0) {
                ...
                game.getModel().getCharactersManager().resetPosition(40, 130);
